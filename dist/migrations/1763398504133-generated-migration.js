...
exports.GeneratedMigration1763398504133 = void 0;
class GeneratedMigration1763398504133 {
    constructor() {
        this.name = 'GeneratedMigration1763398504133';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" SERIAL NOT NULL, "title" character varying(255) NOT NULL, "description" text, "status" character varying(255) NOT NULL DEFAULT 'pending', "due_date" date, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comment" ("id" SERIAL NOT NULL, "content" text NOT NULL, CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "assignment" ("id" SERIAL NOT NULL, CONSTRAINT "PK_43c2f5a3859f54cedafb270f37e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "project" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
...
exports.GeneratedMigration1763398504133 = GeneratedMigration1763398504133;
//# sourceMappingURL=1763398504133-generated-migration.js.map